    ...
    <x-slot name="header">
        <div class="max-w-7xl mx-auto">
            <div class="bg-white/70 backdrop-blur-md rounded-xl px-6 py-4 shadow">
                <h2 class="text-xl text-green-800 leading-tight">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-blue-100 shadow-sm sm:rounded-lg p-6 bg-gradient-to-b from-white to-[#CDFFC7]">
                <form action="{{ route('sales.update', $sale->id) }}" method="POST">
                        ...
                        <div id="product-container" class="space-y-3">
                            ...
                            <div class="flex flex-wrap md:flex-nowrap gap-2 items-center bg-white p-3 rounded-lg border border-green-100 product-row">
                                ...
                                <div class="w-36">
                                    ...
                                    <input type="text" class="w-full border rounded px-3 py-2 bg-gray-50 text-center row-subtotal" readonly value="Rp {{ number_format($detail->subtotal, 0, ',', '.') }}">
                                </div>
                                <div class="pt-5">
                    ...
                    <div class="mb-4">
                        <label class="block mb-1 text-gray-700">Total Keseluruhan</label>
                        <input type="text" id="grand_total_display" class="w-full border rounded px-3 py-2 bg-gray-100 text-gray-700 text-lg" readonly value="Rp {{ number_format($sale->total, 0, ',', '.') }}">
